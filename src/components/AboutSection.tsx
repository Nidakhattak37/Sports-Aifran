    ...
    <section id="about" className="py-16 sm:py-20 bg-white text-slate-900 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-14 space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100/90 text-slate-800 font-['JetBrains_Mono',monospace] text-xs font-bold uppercase tracking-wider border border-slate-200/80 shadow-xs">
          ...
          <p className="text-slate-600 font-['Plus_Jakarta_Sans',sans-serif] text-xs sm:text-base leading-relaxed">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-[#F8FAF9] p-6 sm:p-7 rounded-2xl border border-slate-200/80 shadow-xs space-y-3.5">
              <div className="flex items-start gap-2 text-slate-900">
                ...
                <h3 className="text-lg sm:text-xl font-extrabold font-['Outfit',sans-serif] uppercase tracking-tight leading-snug">
                  FROM SIALKOT WORKSHOP TO GLOBAL OEM PARTNER
                </h3>
              </div>

              <p className="text-slate-600 font-['Plus_Jakarta_Sans',sans-serif] text-xs sm:text-sm leading-relaxed">
                Rooted in the renowned industrial manufacturing hub of Sialkot, AIFRAN SPORTS began as a specialized PVC patch and craftsmanship workshop. Through continuous investment in heavy-duty automated machinery, laser cutting systems, and military-grade textiles, we have evolved into a Tier-1 OEM manufacturing partner.
              </p>
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-center gap-2 text-amber-600 font-['JetBrains_Mono',monospace] font-extrabold text-xs uppercase tracking-wider">
              ...
              <div className="grid grid-cols-5 gap-1.5 bg-slate-100 p-1.5 rounded-xl border border-slate-200/80">
                {TIMELINE_DATA.map((milestone, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="text-xs sm:text-sm font-['Outfit',sans-serif] font-extrabold">{milestone.year}</div>
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-[#F8FAF9] border border-slate-200/80 space-y-2.5 shadow-xs">
                <div className="flex justify-between items-center font-['JetBrains_Mono',monospace]">
                  <span className="text-xs font-extrabold uppercase tracking-wider text-[#EA580C]">
                    YEAR {currentMilestone.year}
                  </span>
                  <span className="text-[10px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded-full bg-slate-200/70 text-slate-700 border border-slate-300/60">
                    MILESTONE {activeMilestoneIndex + 1} OF {TIMELINE_DATA.length}
                  </span>
                </div>

                <h4 className="text-base sm:text-lg font-extrabold font-['Outfit',sans-serif] text-slate-900 uppercase tracking-tight">
                  {currentMilestone.title}
                </h4>

                <p className="text-xs sm:text-sm text-slate-600 font-['Plus_Jakarta_Sans',sans-serif] leading-relaxed">
                  {currentMilestone.description}
                </p>

                {currentMilestone.bulletPoint && (
                  <div className="pt-2 flex items-center gap-2 text-xs font-medium text-slate-700 font-['Plus_Jakarta_Sans',sans-serif]">
